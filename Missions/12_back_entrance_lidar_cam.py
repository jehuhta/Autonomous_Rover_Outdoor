...
from functions import lidar_thread, lidar_loop, get_obstacle_info, avoid_obstacle, collect_frames, predict_frames, push_objlogs_db, get_battery, push_battery_db, push_gps_db, create_gps_table
import datetime
import camera
...
try:
    ...
    MODEL_PATH  = "../Models/yolo2_electric_boogaloo/best2.pt"
    ...
    async def run():
        ...
        await asyncio.gather(
            ...
            push_gps_db(drone, mission_complete),
        )
